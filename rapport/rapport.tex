...
\subparagraph{}  Nous nous sommes donc tournés vers un papier sur les zonotopes \cite{hscc2005} pour implémenter cette méthode en dimension N. [ Si tu veux raconter des trucs ]
